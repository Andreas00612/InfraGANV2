...
def feature_visualization(x, module_type, stage, n=32, save_dir=r'D:\InfraGAN\InfraGAN\visualize_GAN\visualize_H_Night'):
    """
    ...
    if height > 1 and width > 1:
        f = save_dir + '/' +  f"{module_type}_stage{stage}_features.png"  # filename
