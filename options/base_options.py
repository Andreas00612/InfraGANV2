...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='unet_512',
        ...
        self.parser.add_argument('--seed', type=int, default=128, help='random seed')
        self.parser.add_argument('--test_map', type=str, default=r'D:\InfraGAN\InfraGAN\rgb_to_thermal_vid_map.json',
                                 help='the path of test data pair')
        ...
        self.parser.add_argument('--no_center_crop', action='store_true')
        self.parser.add_argument('--no_add_noise',action='store_true')
        self.parser.add_argument('--no_bright',action='store_true')
